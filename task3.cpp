...
public:
    ...
    virtual void print() {
        cout << "\t" << passport->getName() << " " << passport->getSurname() << endl;
        cout << "\t" << "Serial number: " << getSerialNumber() << endl;
        cout << "\t" << "Start insurance date: " << getStartInsuranceDate() << endl;
        cout << "\t" << "End insurance date: " << getEndInsuranceDate() << endl;
        cout << "\t" << "Company: " << getCompany() << endl;
        cout << "\t" << "Policy information: " << getPolicyInformation() << endl;
    }
...
public:
    ...
    ObligatoralyPolicy(Passport *passport, int serialNumber,
                       char *startInsuranceDate,
                       char *endInsuranceDate, char *company) : Policy(passport, serialNumber,
                                                         startInsuranceDate, endInsuranceDate, company) {
...
void taskThreeRun() {
    ...
    while (true) {
        cout
                << "Enter command (passport_list, policies_list, passport_enter, obl_policy, os_policy, ho_policy, choose_policy, count):"
                << endl;
        cin >> command;
